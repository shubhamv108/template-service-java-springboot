...
public class ResponseUtils {
    ...
    public static ResponseEntity<?> getResponseEntity(int statusCode, Object data, java.util.Map<String, java.util.List<String>> headers) {
        return getResponseEntity(statusCode, data, null, headers);
    }

    public static ResponseEntity<?> getResponseEntity(int statusCode, Object data, java.util.Map<String, java.util.List<String>> headers, String headerKey, String... headerValues) {
        headers.put(headerKey, java.util.Arrays.asList(headerValues));
        return getResponseEntity(statusCode, data, null, headers);
    }

    public static ResponseEntity<?> getResponseEntity(int statusCode, Object data, Object errors, java.util.Map<String, java.util.List<String>> headers) {
        ServiceResponse response = ServiceResponse.builder().
                statusCode(statusCode).
                data(data).
                error(errors).
