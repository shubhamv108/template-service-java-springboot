...
public class RequestResponseLoggingFilter implements Filter {
	...
	public void doFilter(ServletRequest servletRequest, ServletResponse servletResponse, FilterChain chain)
		...
		java.util.Map<String, Object> requestHeaders = this.getHeaders(request.getHeaderNames().asIterator(),
		...
		org.springframework.web.util.ContentCachingResponseWrapper responseCacheWrapperObject = new org.springframework.web.util.ContentCachingResponseWrapper(
				response);

		chain.doFilter(servletRequest, servletResponse);

		java.util.Map<String, Object> responseHeaders = this.getHeaders(request.getHeaderNames().asIterator(),
